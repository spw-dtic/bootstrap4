...
<a href="#collapse-${currentNode.identifier}" class="btn btn${outline}-${style} ${size} ${state}" ${aria} data-toggle="collapse" aria-expanded="false" aria-controls="collapse-${currentNode.identifier}">${title}</a>
